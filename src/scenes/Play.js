class Play extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('Bulletship', './assets/Bulletship.png');
        this.load.image('particle', './assets/particle.png');
        // load spritesheet
        //this.load.spritesheet('particle', './assets/particle.png', {frameWidth: 64, frameHeight: 32, startFrame: 0, endFrame: 9});
      }
    ...
    create() {
        ...
        this.enemyShip = new Spaceship(this, game.config.width, borderUISize*8 + borderPadding*4, 'Bulletship', 0, 50, game.settings.spaceshipSpeed*2).setOrigin(0,0);
        // define keys
        ...
        this.anims.create({
            key: 'explode',
            frames: this.anims.generateFrameNumbers('particle', { start: 0, end: 9, first: 0}),
            frameRate: 30
        });
        // initialize score
        this.p1Score = 0;
    ...
    update() {
        ...
        if (this.checkCollision(this.p1Rocket, this.enemyShip)) {
            this.p1Rocket.reset();
            this.shipExplode(this.enemyShip);
        }
    }
